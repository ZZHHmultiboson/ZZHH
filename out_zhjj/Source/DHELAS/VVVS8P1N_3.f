...
C     
      SUBROUTINE VVVS8P1N_3(V1, V2, S4, COUP,V3)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      V3(3)= COUP*S4(3)*(TMP9*(P4(0)*(+CI*(TMP11)-CI*(TMP12))+TMP10*(
     $ -CI*(P1(0))+CI*(P2(0))))+(TMP1*(V1(3)*(+CI*(TMP14+TMP15))+(-CI
     $ *(P1(0)*TMP2)+CI*(P4(0)*TMP8)))+(TMP5*(V2(3)*(-1D0)*(+CI*(TMP14
     $ +TMP15))+(+CI*(P2(0)*TMP4)-CI*(P4(0)*TMP7)))+(TMP10*(+CI*(V1(3)
     $ *TMP7)-CI*(V2(3)*TMP8))+(-CI*(V1(3)*TMP4*TMP12)+CI*(V2(3)*TMP2
     $ *TMP11))))))
      V3(4)= COUP*S4(3)*(TMP9*(P4(1)*(-CI*(TMP11)+CI*(TMP12))+TMP10*(
     $ +CI*(P1(1))-CI*(P2(1))))+(TMP1*(V1(4)*(-1D0)*(+CI*(TMP14+TMP15))
     $ +(+CI*(P1(1)*TMP2)-CI*(P4(1)*TMP8)))+(TMP5*(V2(4)*(+CI*(TMP14
     $ +TMP15))+(-CI*(P2(1)*TMP4)+CI*(P4(1)*TMP7)))+(TMP10*(-CI*(V1(4)
     $ *TMP7)+CI*(V2(4)*TMP8))+(+CI*(V1(4)*TMP4*TMP12)-CI*(V2(4)*TMP2
     $ *TMP11))))))
      V3(5)= COUP*S4(3)*(TMP9*(P4(2)*(-CI*(TMP11)+CI*(TMP12))+TMP10*(
     $ +CI*(P1(2))-CI*(P2(2))))+(TMP1*(V1(5)*(-1D0)*(+CI*(TMP14+TMP15))
     $ +(+CI*(P1(2)*TMP2)-CI*(P4(2)*TMP8)))+(TMP5*(V2(5)*(+CI*(TMP14
     $ +TMP15))+(-CI*(P2(2)*TMP4)+CI*(P4(2)*TMP7)))+(TMP10*(-CI*(V1(5)
     $ *TMP7)+CI*(V2(5)*TMP8))+(+CI*(V1(5)*TMP4*TMP12)-CI*(V2(5)*TMP2
     $ *TMP11))))))
      V3(6)= COUP*S4(3)*(TMP9*(P4(3)*(-CI*(TMP11)+CI*(TMP12))+TMP10*(
     $ +CI*(P1(3))-CI*(P2(3))))+(TMP1*(V1(6)*(-1D0)*(+CI*(TMP14+TMP15))
     $ +(+CI*(P1(3)*TMP2)-CI*(P4(3)*TMP8)))+(TMP5*(V2(6)*(+CI*(TMP14
     $ +TMP15))+(-CI*(P2(3)*TMP4)+CI*(P4(3)*TMP7)))+(TMP10*(-CI*(V1(6)
     $ *TMP7)+CI*(V2(6)*TMP8))+(+CI*(V1(6)*TMP4*TMP12)-CI*(V2(6)*TMP2
     $ *TMP11))))))
      END
