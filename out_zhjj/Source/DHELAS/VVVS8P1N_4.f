...
C     
      SUBROUTINE VVVS8P1N_4(V1, V2, V3, COUP,S4)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      S4(3)= COUP*(TMP9*(TMP10*(-CI*(TMP0)+CI*(TMP3))+TMP6*(+CI*(TMP11)
     $ -CI*(TMP12)))+(TMP1*(TMP13*(+CI*(TMP14+TMP15))+(-CI*(TMP0*TMP2)
     $ +CI*(TMP6*TMP8)))+(TMP16*(TMP5*(-1D0)*(+CI*(TMP14+TMP15))+(-CI
     $ *(TMP8*TMP10)+CI*(TMP2*TMP11)))+(TMP13*(+CI*(TMP7*TMP10)-CI
     $ *(TMP4*TMP12))+TMP5*(+CI*(TMP3*TMP4)-CI*(TMP6*TMP7))))))
      END
