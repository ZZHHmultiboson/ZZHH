...
C     
      SUBROUTINE VVVS7P1N_3(V1, V2, S4, COUP,V3)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      V3(3)= COUP*S4(3)*(TMP9*(P1(0)*(-1D0)*(+CI*(TMP15+TMP10))+(P2(0)
     $ *(+CI*(TMP14+TMP10))+P4(0)*(+CI*(TMP11)-CI*(TMP12))))+(V1(3)
     $ *(TMP1*(-1D0)*(+CI*(TMP14+TMP15))+(TMP4*(-CI*(TMP23)+CI*(TMP12))
     $ +TMP7*(+CI*(TMP15+TMP10))))+(V2(3)*(TMP14*(-CI*(TMP8)+CI*(TMP5))
     $ +(TMP2*(+CI*(TMP23)-CI*(TMP11))+(-CI*(TMP8*TMP10)+CI*(TMP5
     $ *TMP15))))+(P1(0)*(+CI*(TMP1*TMP2+TMP4*TMP8))+(P2(0)*(-1D0)*(
     $ +CI*(TMP2*TMP7+TMP4*TMP5))+P4(0)*(-CI*(TMP5*TMP7)+CI*(TMP1*TMP8)
     $ ))))))
      V3(4)= COUP*S4(3)*(TMP9*(P1(1)*(+CI*(TMP15+TMP10))+(P2(1)*(-1D0)
     $ *(+CI*(TMP14+TMP10))+P4(1)*(-CI*(TMP11)+CI*(TMP12))))+(V1(4)
     $ *(TMP1*(+CI*(TMP14+TMP15))+(TMP4*(+CI*(TMP23)-CI*(TMP12))-TMP7
     $ *(+CI*(TMP15+TMP10))))+(V2(4)*(TMP14*(+CI*(TMP8)-CI*(TMP5))
     $ +(TMP2*(-CI*(TMP23)+CI*(TMP11))+(+CI*(TMP8*TMP10)-CI*(TMP5
     $ *TMP15))))+(P1(1)*(-1D0)*(+CI*(TMP1*TMP2+TMP4*TMP8))+(P2(1)*(
     $ +CI*(TMP2*TMP7+TMP4*TMP5))+P4(1)*(+CI*(TMP5*TMP7)-CI*(TMP1*TMP8)
     $ ))))))
      V3(5)= COUP*S4(3)*(TMP9*(P1(2)*(+CI*(TMP15+TMP10))+(P2(2)*(-1D0)
     $ *(+CI*(TMP14+TMP10))+P4(2)*(-CI*(TMP11)+CI*(TMP12))))+(V1(5)
     $ *(TMP1*(+CI*(TMP14+TMP15))+(TMP4*(+CI*(TMP23)-CI*(TMP12))-TMP7
     $ *(+CI*(TMP15+TMP10))))+(V2(5)*(TMP14*(+CI*(TMP8)-CI*(TMP5))
     $ +(TMP2*(-CI*(TMP23)+CI*(TMP11))+(+CI*(TMP8*TMP10)-CI*(TMP5
     $ *TMP15))))+(P1(2)*(-1D0)*(+CI*(TMP1*TMP2+TMP4*TMP8))+(P2(2)*(
     $ +CI*(TMP2*TMP7+TMP4*TMP5))+P4(2)*(+CI*(TMP5*TMP7)-CI*(TMP1*TMP8)
     $ ))))))
      V3(6)= COUP*S4(3)*(TMP9*(P1(3)*(+CI*(TMP15+TMP10))+(P2(3)*(-1D0)
     $ *(+CI*(TMP14+TMP10))+P4(3)*(-CI*(TMP11)+CI*(TMP12))))+(V1(6)
     $ *(TMP1*(+CI*(TMP14+TMP15))+(TMP4*(+CI*(TMP23)-CI*(TMP12))-TMP7
     $ *(+CI*(TMP15+TMP10))))+(V2(6)*(TMP14*(+CI*(TMP8)-CI*(TMP5))
     $ +(TMP2*(-CI*(TMP23)+CI*(TMP11))+(+CI*(TMP8*TMP10)-CI*(TMP5
     $ *TMP15))))+(P1(3)*(-1D0)*(+CI*(TMP1*TMP2+TMP4*TMP8))+(P2(3)*(
     $ +CI*(TMP2*TMP7+TMP4*TMP5))+P4(3)*(+CI*(TMP5*TMP7)-CI*(TMP1*TMP8)
     $ ))))))
      END
