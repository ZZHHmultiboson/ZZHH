...
C     
      SUBROUTINE VVVS4_0(V1, V2, V3, S4, COUP,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      VERTEX = COUP*S4(3)*(TMP0*(+CI*(TMP4*TMP8)-CI*(TMP9*TMP15))
     $ +(TMP13*(+CI*(TMP7*TMP15)-CI*(TMP4*TMP23))+(TMP14*(+CI*(TMP3
     $ *TMP9)-CI*(TMP8*TMP16))+TMP2*(-CI*(TMP3*TMP7)+CI*(TMP16*TMP23)))
     $ ))
      END
...
C      P(-1,1)*P(-1,2)*P(1,4)*Metric(2,3)
C     
      SUBROUTINE VVVS4_7_0(V1, V2, V3, S4, COUP1, COUP2,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 COUP1
      ...
      COMPLEX*16 TMP
      COMPLEX*16 VERTEX
      CALL VVVS4_0(V1,V2,V3,S4,COUP1,VERTEX)
      CALL VVVS7_0(V1,V2,V3,S4,COUP2,TMP)
      VERTEX = VERTEX + TMP
      END
