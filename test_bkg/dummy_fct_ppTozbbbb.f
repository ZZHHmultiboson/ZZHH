...
c
      ...
      REAL*8 PTOT(0:3)    ! ptot of the first system bb~
      REAL*8 PTOT1(0:3)   ! ptot of the first system bb~
      REAL*8 PTOT2(0:3)   ! ptot of the second system bb~
      REAL*8 PTOT3(0:3)   ! ptot of the first system bb~ second combination
      REAL*8 PTOT4(0:3)   ! ptot of the second system bb~ second combination
      REAL*8 themass      ! inv mass of the system bb~bb~
      REAL*8 themass1     ! inv mass of the first system bb~
      REAL*8 themass2     ! inv mass of the second system bb~
      REAL*8 themass3     ! inv mass of the third system bb~
      REAL*8 themass4     ! inv mass of the fourth system bb~
      logical in1,in2,in3,in4,found_hh
      integer i,j
c
      include 'maxamps.inc'
...
c
      do k=0,3
         ...
         ptot2(k)=pb(k,1)+pbt(k,1)
         ptot3(k)=pb(k,0)+pbt(k,1)
         ptot4(k)=pb(k,1)+pbt(k,0)
      enddo
      themass1=sqrt(ptot1(0)**2-ptot1(1)**2-ptot1(2)**2-ptot1(3)**2)
      themass2=sqrt(ptot2(0)**2-ptot2(1)**2-ptot2(2)**2-ptot2(3)**2)
      themass3=sqrt(ptot3(0)**2-ptot3(1)**2-ptot3(2)**2-ptot3(3)**2)
      themass4=sqrt(ptot4(0)**2-ptot4(1)**2-ptot4(2)**2-ptot4(3)**2)
c
      in1=themass1.gt.105d0.and.themass1.lt.145d0
      in2=themass2.gt.105d0.and.themass2.lt.145d0
      in3=themass3.gt.105d0.and.themass3.lt.145d0
      in4=themass4.gt.105d0.and.themass4.lt.145d0
      found_hh=(in1.and.in2).or.(in3.and.in4) 
c      
      if(.not.found_hh)then
         dummy_cuts=.false.
         return
      endif
c
